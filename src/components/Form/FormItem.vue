<template>
    <div class="el-form-item" :class="{
        ...
        <div class="el-form-item__content">
            ...
            <div class="ell-form-item__error-msg" v-if="validateStatus.state === 'error'">
...
const innerValue = computed(() => {
    ...
    if (model && props.prop && !isNil(model[props.prop])) { // is null or undefined
...
const validate = async (trigger?: string) => {
    ...
    const triggeredRule = getTriggeredRules(trigger)
    if (triggeredRule.length === 0) {
        return true
    }
    if (modelName) {
